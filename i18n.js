...
const I18N = {
    ...
    ai_planner: {zh:'专属AI规划师', en:'AI Planner', ja:'AIプランナー', ko:'AI 플래너', es:'Planificador AI'},
    ai_planner_start: {zh:'开始规划', en:'Start Planning', ja:'計画開始', ko:'시작하기', es:'Empezar'},
    ai_planner_desc: {zh:'定制专属学习路径 · 快速拿到证书', en:'Custom learning path · Get certified fast', ja:'専用学習プランをカスタマイズ', ko:'맞춤 학습 경로 · 빠른 인증', es:'Ruta personalizada · Certifícate rápido'},
